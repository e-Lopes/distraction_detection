...
Usa a CLI `python -m fase_2`, `src/pipeline.py` e `src/reporting.py`, sem segundo pipeline. `configs/modern_experiment.yaml` herda `final_experiment.yaml` e isola resultados em `outputs/modern_v1`. Consulte também `results/audits/experimental_readiness_2026-09-14.md` e `docs/protocols/temporal_next_round_protocol.md`.
