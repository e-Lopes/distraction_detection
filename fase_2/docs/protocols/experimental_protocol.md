...
- `results/historical/G1/figures/`: comparações, distribuição entre folds e matrizes de confusão.
...
- `results/historical/G2/figures/`: curvas por época, matrizes, comparações e variabilidade entre folds.
...
- `outputs/metrics/G3/g3_report.md` e `results/historical/G3/figures/`: relatório e gráficos.
...
- `results/historical/G4/g4_imbalance_results.md` e `results/historical/G4/figures/`.
