...
SVM permanece competitivo: melhor media historica em w=60 de nan. SVM, Random Forest e XGBoost historicos continuam intactos. O novo screening compara Regressao Logistica, SVM, Random Forest e XGBoost com exatamente a mesma tabela `temporal_behavior_v1`, w=60, seed 42 e quatro folds (16 runs).

## 12. Resultados dos modelos temporais

Em seed 42: LSTM/w60 nan, TCN/w60 nan e Transformer/w150 nan. Eles vencem regras fixas, mas nao estabelecem superioridade geral sobre SVM. Esses resultados serao reutilizados; os 16 novos runs LSTM/B estao bloqueados ate promocao formal apos o screening.
...
Fase configurada: **development**. Desenvolvimento e teste externo não são agrupados.
...
|---|---|---|---|
| svm | R0_flat | [60] | class_weights |
| multirocket_ridge | R0 | [60] | class_weights |
| hydra_multirocket_ridge | R0 | [60] | class_weights |
| mantis_frozen_ridge | R0 | [60] | class_weights |
| lstm | R0 | [60] | class_weights |
| tcn | R0 | [60] | class_weights |
| transformer | R0 | [60] | class_weights |
| inception_individual | R0 | [60] | class_weights |

### Resultados por fase

- ('hydra_multirocket_ridge', 'validation', 'f1', 'alert'): média descritiva=0.7641; n=4. Não interpretar repetições de seed como sessões independentes.
- ('hydra_multirocket_ridge', 'validation', 'f1', 'distraction'): média descritiva=0.2408; n=4. Não interpretar repetições de seed como sessões independentes.
- ('hydra_multirocket_ridge', 'validation', 'f1', 'fatigue'): média descritiva=0.0033; n=4. Não interpretar repetições de seed como sessões independentes.
- ('hydra_multirocket_ridge', 'validation', 'macro_f1', ''): média descritiva=0.3361; n=4. Não interpretar repetições de seed como sessões independentes.
- ('inception_individual', 'validation', 'f1', 'alert'): média descritiva=0.8598; n=4. Não interpretar repetições de seed como sessões independentes.
- ('inception_individual', 'validation', 'f1', 'distraction'): média descritiva=0.3358; n=4. Não interpretar repetições de seed como sessões independentes.
- ('inception_individual', 'validation', 'f1', 'fatigue'): média descritiva=0.0644; n=4. Não interpretar repetições de seed como sessões independentes.
- ('inception_individual', 'validation', 'macro_f1', ''): média descritiva=0.4200; n=4. Não interpretar repetições de seed como sessões independentes.
- ('lstm', 'validation', 'f1', 'alert'): média descritiva=0.8558; n=4. Não interpretar repetições de seed como sessões independentes.
- ('lstm', 'validation', 'f1', 'distraction'): média descritiva=0.3323; n=4. Não interpretar repetições de seed como sessões independentes.
- ('lstm', 'validation', 'f1', 'fatigue'): média descritiva=0.1114; n=4. Não interpretar repetições de seed como sessões independentes.
- ('lstm', 'validation', 'macro_f1', ''): média descritiva=0.4332; n=4. Não interpretar repetições de seed como sessões independentes.
- ('mantis_frozen_ridge', 'validation', 'f1', 'alert'): média descritiva=0.8484; n=4. Não interpretar repetições de seed como sessões independentes.
- ('mantis_frozen_ridge', 'validation', 'f1', 'distraction'): média descritiva=0.2590; n=4. Não interpretar repetições de seed como sessões independentes.
- ('mantis_frozen_ridge', 'validation', 'f1', 'fatigue'): média descritiva=0.0000; n=4. Não interpretar repetições de seed como sessões independentes.
- ('mantis_frozen_ridge', 'validation', 'macro_f1', ''): média descritiva=0.3691; n=4. Não interpretar repetições de seed como sessões independentes.
- ('multirocket_ridge', 'validation', 'f1', 'alert'): média descritiva=0.7137; n=4. Não interpretar repetições de seed como sessões independentes.
- ('multirocket_ridge', 'validation', 'f1', 'distraction'): média descritiva=0.2595; n=4. Não interpretar repetições de seed como sessões independentes.
- ('multirocket_ridge', 'validation', 'f1', 'fatigue'): média descritiva=0.0215; n=4. Não interpretar repetições de seed como sessões independentes.
- ('multirocket_ridge', 'validation', 'macro_f1', ''): média descritiva=0.3316; n=4. Não interpretar repetições de seed como sessões independentes.
- ('svm', 'validation', 'f1', 'alert'): média descritiva=0.8381; n=4. Não interpretar repetições de seed como sessões independentes.
- ('svm', 'validation', 'f1', 'distraction'): média descritiva=0.2374; n=4. Não interpretar repetições de seed como sessões independentes.
- ('svm', 'validation', 'f1', 'fatigue'): média descritiva=0.0000; n=4. Não interpretar repetições de seed como sessões independentes.
- ('svm', 'validation', 'macro_f1', ''): média descritiva=0.3585; n=4. Não interpretar repetições de seed como sessões independentes.
- ('tcn', 'validation', 'f1', 'alert'): média descritiva=0.8293; n=4. Não interpretar repetições de seed como sessões independentes.
- ('tcn', 'validation', 'f1', 'distraction'): média descritiva=0.2981; n=4. Não interpretar repetições de seed como sessões independentes.
- ('tcn', 'validation', 'f1', 'fatigue'): média descritiva=0.1014; n=4. Não interpretar repetições de seed como sessões independentes.
- ('tcn', 'validation', 'macro_f1', ''): média descritiva=0.4096; n=4. Não interpretar repetições de seed como sessões independentes.
- ('transformer', 'validation', 'f1', 'alert'): média descritiva=0.8211; n=4. Não interpretar repetições de seed como sessões independentes.
- ('transformer', 'validation', 'f1', 'distraction'): média descritiva=0.2927; n=4. Não interpretar repetições de seed como sessões independentes.
- ('transformer', 'validation', 'f1', 'fatigue'): média descritiva=0.2116; n=4. Não interpretar repetições de seed como sessões independentes.
- ('transformer', 'validation', 'macro_f1', ''): média descritiva=0.4418; n=4. Não interpretar repetições de seed como sessões independentes.

### Custos, falhas e resultados negativos
