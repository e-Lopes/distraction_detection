    ...
    with open(OUTPUT_LOG, "w") as log_file:
        ...
        try:
            while cap.isOpened():
                ...
                # ✅ Salvar frame com nome formatado
                frame_filename = f"{video_basename}_frame{frame_count:06d}_{current_state}.jpg"
                frame_output_path = os.path.join("frames", frame_filename)
